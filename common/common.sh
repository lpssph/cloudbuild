...
cd ${GITHUB_WORKSPACE}
bash <(curl -fsSL https://raw.githubusercontent.com/0118Add/CloudBuild/main/common/custom/first.sh)
}
...
function Diy_update() {
bash <(curl -fsSL https://raw.githubusercontent.com/0118Add/CloudBuild/main/common/custom/ubuntu.sh)
if [[ $? -ne 0 ]];then
